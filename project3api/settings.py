"""
Django settings for project3api project.
...
SECRET_KEY = 'django-insecure-v%s&1fqayh1s(qr!uc7^)c^sk=^^6*ssvvmy-r*%lp9if78wvj'
...
WSGI_APPLICATION = 'project3api.wsgi.application'
